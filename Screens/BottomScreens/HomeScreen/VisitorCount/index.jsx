                        ...
                        {loadData ? (
                            ...
                            <View>
                                ...
                                <View style={[styles.row, styles.listHeader]}>
                                    ...
                                    <Text style={[styles.header, styles.cell, styles.DepartmentName]}>Visitor Name</Text>
                                ...
                                {paginatedData.length === 0 ? (
                                    ...
                                    paginatedData.map((item, index) => (
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.DepartmentName]}>{item.visitor_name}</Text>
                                            <Text style={[styles.cell, styles.EmployeeName]}>{item.date}</Text>
                                            <Text style={[styles.cell, styles.StartDate]}>{item.in_time}</Text>
                                            <Text style={[styles.cell, styles.EndDate]}>{item.out_time}</Text>
                                        </View>
                                    ))
                                )}
