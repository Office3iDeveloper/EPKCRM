...
const OdCount = () => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/viewemp_Details/ON';
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/OD_Count.xlsx';
