...
const AbsentCount = () => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/viewemp_Details/A';
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/Absent_Count.xlsx';
