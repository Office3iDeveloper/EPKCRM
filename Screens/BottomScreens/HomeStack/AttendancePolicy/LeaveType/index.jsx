...
const LeaveType = () => {
    ...
    const openEditModal = (slot) => {
        setEditedShiftSlot(slot.request_type_name);
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            if (!editedShiftSlot) {
                setEditedShiftError('Leave Type is required');
                setEditLoad(false);
                return;
            } else {
                setEditedShiftError('');
            ...
            const response = await axios.put(apiUrl, {
                id: selectedSlotId,
                request_type_name: editedShiftSlot,
        ...
        <ScrollView>
            ...
            <View style={styles.ShiftSlotContainer}>
                ...
                <View style={styles.ShiftSlotContainerTitle}>
                    <Text style={styles.ShiftSlotContainerTitleText}>Leave Type Form</Text>
                </View>
                ...
                <>
                    <View style={styles.ShiftSlotContainerTitle}>
                        <Text style={styles.ShiftSlotContainerTitleText}>Leave Type List</Text>
                    </View>
                    ...
                    >
                        <View style={styles.modalContainer}>
                            ...
                            <View style={styles.modalContent}>
                                ...
                                <Text style={styles.Heading}>Edit Leave Type Form</Text>
                                <Text style={styles.modalLabelText}>Leave Type</Text>
