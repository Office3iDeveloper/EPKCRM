...
const AttendanceType = () => {
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            if (!editedShiftSlot) {
                setEditedShiftError('Request Type is required');
                setEditLoad(false);
                return;
            } else {
                setEditedShiftError('');
        ...
        <ScrollView>
            ...
            <View style={styles.ShiftSlotContainer}>
                ...
                <View style={styles.ShiftSlotContainerTitle}>
                    <Text style={styles.ShiftSlotContainerTitleText}>Attendance Type Form</Text>
                </View>
                ...
                <>
                    <View style={styles.ShiftSlotContainerTitle}>
                        <Text style={styles.ShiftSlotContainerTitleText}>Attendance Type List</Text>
                    </View>
