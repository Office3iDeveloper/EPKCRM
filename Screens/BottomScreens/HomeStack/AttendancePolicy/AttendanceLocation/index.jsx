...
const AttendanceLocation = () => {
    ...
    const validateFields = () => {
        ...
        if (!shiftSlot) {
            setShiftError('Request Location is required');
            isValid = false;
        } else {
            setShiftError('');
        }
    ...
    const openEditModal = (slot) => {
        setEditedShiftSlot(slot.request_location);
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            if (!editedShiftSlot) {
                setEditedShiftError('Request Location is required');
                setEditLoad(false);
                return;
            } else {
                setEditedShiftError('');
            ...
            const response = await axios.put(apiUrl, {
                id: selectedSlotId,
                request_location: editedShiftSlot,
                request_status: editedStatus,
                updated_by: data.userempid,
            }, {
                headers: {
                    Authorization: `Bearer ${data.token}`
        ...
        <ScrollView>
            ...
            <View style={styles.ShiftSlotContainer}>
                ...
                <View style={styles.ShiftSlotContainerTitle}>
                    <Text style={styles.ShiftSlotContainerTitleText}>Attendance Location Form</Text>
                </View>
                ...
                <>
                    <View style={styles.ShiftSlotContainerTitle}>
                        <Text style={styles.ShiftSlotContainerTitleText}>Attendance Location List</Text>
                    </View>
                                        ...
                                        {Datalist.length === 0 ? (
                                            ...
                                            Datalist.map((item, index) => (
                                                <View key={index} style={[styles.row, styles.listBody]}>
                                                    ...
                                                    <Text style={[styles.cell, styles.DepartmentName]}>{item.request_location}</Text>
                    ...
                    >
                        <View style={styles.modalContainer}>
                            ...
                            <View style={styles.modalContent}>
                                ...
                                <Text style={styles.Heading}>Edit Attendance Location Form</Text>
                                <Text style={styles.modalLabelText}>Request Location</Text>
