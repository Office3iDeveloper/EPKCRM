...
import styles from "../Enquirylist/style";
...
const CustomerList = ({ navigation }) => {
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'name', 'E-mail', 'Company Name', 'Mobile Number'];
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/Customer_List.xlsx';
    ...
    useFocusEffect(
        useCallback(() => {
          // This effect runs when the screen is focused (i.e., when navigating to the screen)
          return () => {
            // This cleanup function runs when the screen loses focus (i.e., swiping back)
