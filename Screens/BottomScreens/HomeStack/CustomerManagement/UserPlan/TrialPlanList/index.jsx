...
import styles from "../../Customer/Enquirylist/style";
...
const TrialPlanList = ({ navigation }) => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/cus_trial_package_List';
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'Name', 'E-mail', 'Company Name', 'Mobile Number', 'Module name', 'Plan name', 'Trial Days', 'Start Date', 'End Date', 'Status'];
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/TrialPlan_list.xlsx';
                        ...
                        {loadData ? (
                            ...
                            <View>
                                ...
                                <View style={[styles.row, styles.listHeader]}>
                                    ...
                                    <Text style={[styles.header, styles.cell, styles.WeekOff]}>Module name</Text>
                                    <Text style={[styles.header, styles.cell, styles.Status]}>Plan name</Text>
                                    <Text style={[styles.header, styles.cell, styles.Status]}>Trial Days</Text>
                                ...
                                {paginatedData.length === 0 ? (
                                    ...
                                    paginatedData.map((item, index) => (
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.WeekOff]}>{item.module_name}</Text>
                                            <Text style={[styles.cell, styles.Status]}>{item.trial_plan_name}</Text>
                                            <Text style={[styles.cell, styles.Status]}>{item.trial_days}</Text>
                                            ...
                                            {/* <View style={styles.listcontentButtonview}>
                                                <TouchableOpacity style={styles.listcontenteditbutton}
                                                    onPress={() => navigation.navigate('Edit Customer Enquiry List', { Id: item })}
                                                >
