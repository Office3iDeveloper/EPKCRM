...
const CompanyList = ({ navigation }) => {
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'Company Name', 'Mailling Name', 'GSTIN / UIN', 'Status', 'Created By', 'Updated By'];
        const tableData1 = datalist.map((rowData, index) => [
            index + 1,
            rowData.company_name,
            rowData.mailing_name,
            rowData.gstin_uin,
            rowData.status,
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/Company_List.xlsx';
                        ...
                        {loadData ? (
                            ...
                            <View>
                                ...
                                <View style={[styles.row, styles.listHeader]}>
                                    ...
                                    <Text style={[styles.header, styles.cell, styles.DepartmentName]}>Company Name</Text>
                                    <Text style={[styles.header, styles.cell, styles.StartDate]}>Mailling Name</Text>
                                    <Text style={[styles.header, styles.cell, styles.EndDate]}>GSTIN / UIN</Text>
                                ...
                                {paginatedData.length == 0 ? (
                                    ...
                                    paginatedData.map((item, index) => (
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.DepartmentName]}>{item.company_name}</Text>
                                            <Text style={[styles.cell, styles.StartDate]}>{item.mailing_name}</Text>
                                            <Text style={[styles.cell, styles.EndDate]}>{item.gstin_uin}</Text>
