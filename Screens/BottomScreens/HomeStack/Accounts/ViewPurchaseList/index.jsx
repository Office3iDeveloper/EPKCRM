...
import styles from "../ViewProformaInvoice/style";
...
const PurchaseInvoiceView = ({ route, navigation }) => {
    ...
    const getApi = async () => {
        ...
        try {
            const apiUrl = `https://office3i.com/development/api/public/api/getbuybowpackproformainvoiceviewlist/${SpecId}`;
