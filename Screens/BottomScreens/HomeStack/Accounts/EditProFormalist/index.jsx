...
const EditProform = ({ navigation, route }) => {
    ...
    const Annlist = async () => {
        ...
        try {
            const apiUrl = `https://office3i.com/development/api/public/api/getbuybowpackproformainvoiceviewlist/${SpecId.id}`;
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://office3i.com/development/api/public/api/getbuybowpackproformainvoiceeditlist';

            const response = await axios.post(apiUrl, {
                id: SpecId.id,
                updated_by: data.userempid,
                status_date: formattedStartDate2 || null,
