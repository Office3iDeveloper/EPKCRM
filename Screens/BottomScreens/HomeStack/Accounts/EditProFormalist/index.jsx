...
const EditProform = ({ navigation, route }) => {
    ...
    const Annlist = async () => {
        ...
        try {
            const apiUrl = `https://epkgroup.in/crm/api/public/api/getbuybowpackproformainvoiceviewlist/${SpecId.id}`;
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://epkgroup.in/crm/api/public/api/getbuybowpackproformainvoiceeditlist';
