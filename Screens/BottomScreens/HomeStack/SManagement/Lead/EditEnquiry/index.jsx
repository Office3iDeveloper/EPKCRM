...
const EditEnquiry = ({ navigation, route }) => {
    ...
    const Annlist = async () => {
        ...
        try {
            const apiUrl = `https://office3i.com/development/api/public/api/getbuybowpacksalesviewlist/${SpecId.id}`;
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://office3i.com/development/api/public/api/office3i_enquiryadd_lead';
    ...
    useEffect(() => {
        ...
        setFName(SpecId.first_name);
        setEmail(SpecId.email);
        setCompanyName(SpecId.company_name);
        setMobileNumber(SpecId.mobile_number)
    }, [SpecId])
        ...
        <ScrollView>
            ...
            <View style={styles.PolicyContainer}>
                ...
                <View style={styles.Inputcontainer}>
                    ...
                    <TouchableOpacity style={styles.StatusTouchable} onPress={toggleDropdownStatus}>
