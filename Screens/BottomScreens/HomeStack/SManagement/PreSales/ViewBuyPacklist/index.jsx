...
const BuyPreSalesInvoiceView = ({ route, navigation }) => {
    ...
    const getApi = async () => {
        ...
        try {
            const apiUrl = `https://office3i.com/development/api/public/api/getbuybowpackpresalesviewlist/${SpecId}`;
...
export default BuyPreSalesInvoiceView;