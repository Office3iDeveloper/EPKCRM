...
const SalesTrialPackList = ({ navigation }) => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/getsales_trialpacklist';
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'Name', 'E-mail', 'Mobile Number', 'Plan Name', 'Start Date', 'End Date', 'Assigned Name', 'Created By', 'Updated By'];
