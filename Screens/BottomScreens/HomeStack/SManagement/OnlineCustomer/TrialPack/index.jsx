...
import styles from "../BuyPack/style";
...
const OCTrialPackList = ({ navigation }) => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/getonline_trialpacklist';
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'Name', 'E-mail', 'Mobile Number', 'Plan Name', 'Start Date', 'End Date'];
                        ...
                        {loadData ? (
                            ...
                            <View>
                                ...
                                <View style={[styles.row, styles.listHeader]}>
                                    ...
                                    {/* <Text style={[styles.header, styles.cell, styles.WeekOff]}>Assigned Name</Text> */}
                                ...
                                {paginatedData.length === 0 ? (
                                    ...
                                    paginatedData.map((item, index) => (
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.EndDate]}>{item.cus_mobile}</Text>
                                            ...
                                            {/* <View style={styles.listcontentButtonview}>
                                                <TouchableOpacity style={styles.listcontenteditbutton}
                                                    // onPress={() => navigation.navigate('Pre Edit Enquiry List', { Id: item })}
                                                >
...
export default OCTrialPackList;