...
const RelievingLetterList = ({ navigation }) => {
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/Relieving_List.xlsx';
                                ...
                                {paginatedData.length === 0 ? (
                                    ...
                                    paginatedData.map((item, index) => (
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.EmployeeName]}>{item.employee_name}</Text>
                                            ...
                                            <View style={styles.listcontentButtonview}>
                                                ...
                                                <TouchableOpacity
                                                    onPress={() => navigation.navigate('View Relieving Letter', { Id: item })}
