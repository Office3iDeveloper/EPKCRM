...
const OfferLetterList = ({ navigation }) => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/offer_list';
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/OfferLetter_List.xlsx';
                                ...
                                {paginatedData.length === 0 ? (
                                    ...
                                    paginatedData.map((item, index) => (
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.EmployeeName]}>{item.name}</Text>
                                            ...
                                            <View style={styles.listcontentButtonview}>
                                                ...
                                                <TouchableOpacity
                                                 onPress={() => navigation.navigate('View Offer Letter', { Id: item })}
