...
import styles from "../../OfferLetter/OfferLetterList/style";
...
const AppointmentLetterList = ({ navigation }) => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/appointment_list';
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'Date', 'Employee Name', 'Designation'];
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/AppoinmentLetter_List.xlsx';
    ...
    const exportToPDF = async () => {
        ...
        try {
            const { filePath } = await RNHTMLtoPDF.convert({
                html: htmlContent,
                fileName: 'AppoinmentLetter_List',
    ...
    return (
        <ScrollView>
            <View style={styles.Container}>
                                        ...
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <View style={styles.listcontentButtonview}>
                                                <TouchableOpacity style={styles.listcontenteditbutton}
                                                    onPress={() => navigation.navigate('Edit Appointment Letter', { Id: item })}
                                                >
                ...
                {pages.length != 0 ? <View style={{ alignItems: 'center' }}>
