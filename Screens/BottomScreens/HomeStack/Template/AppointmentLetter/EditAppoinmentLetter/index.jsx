...
import styles from "../AddAppoinmentLetter/style";
...
const EditAppointmentLetter = ({ route, navigation }) => {
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('https://office3i.com/development/api/public/api/update_appointment_letter', {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        ...
        setEmpName(SpecId.candidate_name);
        ...
        setNotice(SpecId.noties_period_text);
        setStartDate1(new Date(SpecId.start_date));
        setAPName(SpecId.authroised_person_name);
        setAPDesignation(SpecId.authroised_designation);
        seteditedocFile(SpecId.header_attachment);
        seteditedocFile1(SpecId.footer_attached);
        setGrossSalary(SpecId.gross_salary);
        setEmpTC(SpecId.employment_tc);
        ...
        <ScrollView>
            ...
            <View style={styles.PolicyContainer}>
                ...
                <View style={styles.PolicyContainerTitleHeader}>
                    <Text style={styles.PolicyContainerTitleText}>Edit Appointment Letter</Text>
                </View>
...
export default EditAppointmentLetter;