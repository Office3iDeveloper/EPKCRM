...
const LeaveRequest = () => {
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/Leave_Request.xlsx';
                        ...
                        {loadData ? (
                            ...
                            <View>
                                ...
                                <View style={[styles.row, styles.listHeader]}>
                                    ...
                                    <Text style={[styles.header, styles.cell, styles.Action]}>Status</Text>
                                </View>
                                        ...
                                        <View key={index} style={[styles.row, styles.listBody]}>
                                            ...
                                            <Text style={[styles.cell, styles.Status]}>{item.tl_status === null ? "Pending" : item.tl_status}</Text>
                                            {
                                                item.emp_status === "Pending" ?
                                                    ...
                                                    <Text style={[styles.cell, styles.Action]}>{item.emp_status}</Text>
                                            }
                                        </View>
                                    ))
                                )}
