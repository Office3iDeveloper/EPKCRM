...
const TLOtRequest = () => {
    ...
    const exportToExcel = async () => {
        const tableHead = ['S.No', 'Name', 'Department', 'Type', 'Location', 'Shift Slot', 'From Time', 'To Time', 'Total Hours', 'Reason','status'];
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/TLot_request_list.xlsx';
