...
const EMPActiveLog = () => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/employee_logs';
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const fileUri = RNFS.CachesDirectoryPath + '/Employee_ActivityLog.xlsx';
                        ...
                        {loadData ? (
                            ...
                            <View>
                                ...
                                <View style={[styles.row, styles.listHeader]}>
                                    ...
                                    <Text style={[styles.header, styles.cell, styles.DepartmentName]}>Activity Done By</Text>
                                    <Text style={[styles.header, styles.cell, styles.EmployeeName]}>Message</Text>
                                    <Text style={[styles.header, styles.cell, styles.StartDate]}>Created At</Text>
                                    <Text style={[styles.header, styles.cell, styles.EndDate]}>Updated At</Text>
                                </View>
