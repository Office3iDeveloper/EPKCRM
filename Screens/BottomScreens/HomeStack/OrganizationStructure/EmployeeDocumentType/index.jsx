...
const DocumentType = () => {
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post(apiUrl, {
                ...
                document_status: selectedStatus,
    ...
    const openEditModal = (slot) => {
        setEditedShiftSlot(slot.document_name);
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.put(apiUrl, {
                id: selectedSlotId,
                document_name: editedShiftSlot,
                document_status: editedStatus,
                updated_by: data.userempid,
            }, {
                headers: {
                    Authorization: `Bearer ${data.token}`
        ...
        <ScrollView>
            <View style={styles.ShiftSlotContainer}>
                ...
                <View style={styles.ShiftSlotContainerTitle}>
                    <Text style={styles.ShiftSlotContainerTitleText}>Employee Document Type Form</Text>
                </View>
