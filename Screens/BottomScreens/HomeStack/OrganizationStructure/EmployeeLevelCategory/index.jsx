...
const LevelCategory = () => {
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://office3i.com/development/api/public/api/emplevelcategoryinsert';

            const response = await axios.post(apiUrl, {
                emplevel_name: shiftSlot,
                emplevel_status: selectedStatus,
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://office3i.com/development/api/public/api/view_emplevelcategory';
    ...
    const confirmDelete = async () => {
        ...
        if (slotToDelete) {
            ...
            try {
                ...
                const apiUrl = `https://office3i.com/development/api/public/api/delete_emplevelcategory`;
                const response = await axios.post(apiUrl, {
                    id: slotToDelete,
    ...
    const openEditModal = (slot) => {
        setEditedShiftSlot(slot.level_name);
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://office3i.com/development/api/public/api/update_emplevelcategory';

            const response = await axios.put(apiUrl, {
                id: selectedSlotId,
                emplevel_name: editedShiftSlot,
                emplevel_status: editedStatus,
                updated_by: data.userempid,
            }, {
                headers: {
                    Authorization: `Bearer ${data.token}`
        ...
        <ScrollView>
            <View style={styles.ShiftSlotContainer}>
                <View style={styles.ShiftSlotContainerTitle}>
                    <Text style={styles.ShiftSlotContainerTitleText}>Employee Level Category Form</Text>
                </View>
