...
const PreEditList = ({ navigation, route }) => {
    ...
    const datalistdata = route.params.datalist
    ...
    useEffect(() => {
        ...
        setSelectedDepartments(datalistdata.Assign_sales_departmentname);
        setSelectedMember(datalistdata.Assign_sales_name);
