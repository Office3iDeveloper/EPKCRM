            ...
            <ScrollView>
                ...
                <View style={styles.PolicyContainer}>
                    ...
                    <View style={{ marginTop: '10%', width: '90%', alignItems: 'flex-end' }}>
                        <TouchableOpacity style={styles.HeaderButtonActive} onPress={() => navigation.navigate('Pre Edit Lead', { SpecData: datalist, leadStatus: leadStatus, datalist: datalist })}>
